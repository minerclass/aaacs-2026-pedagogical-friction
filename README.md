...
- `R`: linked resources and companion sites
- `N`: speaker notes
- `O`: slide overview
- `F`: fullscreen
...
- Classroom-signal diagnosis
- Local audience pulse
- Explorable Ong/media-ecology timeline
...
Use the browser print dialog and choose landscape orientation or “Save as PDF.” Print styles render each slide as a separate page.
